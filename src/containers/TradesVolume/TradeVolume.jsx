...
export default class TradeVolume extends Component {
    render() {
        return (
            <div className="card mt-3 tab-card">
                <div className="card-header tab-card-header">
                <div className="">Trades & Volume</div>
                    <ul className="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" id="two-tab" data-toggle="tab" href="#two" role="tab" aria-controls="Two" aria-selected="false">Volume</a>
                        </li>
                    </ul>
                </div>
